...
incoming matter and radiation. It targets two audiences: someone exploring the physics
for the first time, and someone checking the numerics behind the paper below.
...
| `scripts/warpsim.py` | The Python helper for analysing exported trajectory data |
...
The source code is licensed under [AGPL-3.0-or-later](LICENSE). Every source file carries
an `SPDX-License-Identifier` header, and the program shows its licence notice in the
**About** tab.
