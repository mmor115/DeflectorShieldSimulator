...
Every source file in the repository carries an `SPDX-License-Identifier` header naming
this licence, and the two program entry points carry the full notice. The **About** tab of
the **Parameters** window shows the same notice while the program runs.
