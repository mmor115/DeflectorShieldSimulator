...
```bibtex
@article{sanches2026exploring,
  author        = {Sanches, Lucas Timotheo and Morris, Max and Brandt, Steven Robert},
  title         = {Exploring Particle Geodesics in a Warp Drive Spacetime},
  journal       = {arXiv preprint arXiv:2608.08213},
...
Cite the release tag alongside the paper when a result depends on the behavior of a
